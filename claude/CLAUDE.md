...
## What's been done so far (state as of 2026-05-07)
...
After (2) we know whether JustRL "tricks may hurt" holds in our setting. After (5) we have the supervisor-question answer in [`docs/report/SUPERVISOR_MEETING_2026-05-07.md § 6`](../docs/report/SUPERVISOR_MEETING_2026-05-07.md).
