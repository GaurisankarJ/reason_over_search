...
**If you only read one thing after this file**: [docs/TODO_2026-05-04.md](../docs/TODO_2026-05-04.md) is the canonical catch-up doc with the active ablation path. The two state-of-the-world snapshots are [docs/report/CONVERSATION_CONTEXT.md](../docs/report/CONVERSATION_CONTEXT.md) (thesis status) and [docs/internship/CONVERSATION_CONTEXT.md](../docs/internship/CONVERSATION_CONTEXT.md) (Alstom internship side); [docs/report/SUPERVISOR_MEETING.md](../docs/report/SUPERVISOR_MEETING.md) is the two-page story so far for the supervisor (also as PDF in `docs/report/SUPERVISOR_MEETING.pdf` and `docs/report/PROGRESS_REPORT_01.pdf`).
...
**Phase-2 (M2) NeMo-RL training pipeline** — built and smoke-tested end-to-end on Vast.ai 1× A100 80GB ([`docs/training/SMOKE_RESULTS_V4.md`](../docs/training/SMOKE_RESULTS_V4.md)): ~57 s/step at smoke shape; full Search-R1 schedule projects to **11 to 17 days / run, ~$300 to $490 / run** at $1.50/h. Reward-ablation killed by this. The active recipe and ablation plan now drives Phase-2 work (see "What's next" below).
