...
- **Catch-up + active path**: [`docs/todo/`](../docs/todo/) — [`TODO.md`](../docs/todo/TODO.md) is the evergreen pending-work list; [`TODO_2026-05-10.md`](../docs/todo/TODO_2026-05-10.md) is the current dated catch-up doc (best entry point for a fresh session); [`TODO_2026-05-04.md`](../docs/todo/TODO_2026-05-04.md) is the frozen older handoff.
