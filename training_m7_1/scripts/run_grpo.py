...
Usage (delegates argv to the upstream parser, including Hydra overrides):
    ...
    training_m7_1/scripts/run_grpo.py \\
        --config=training_m7_1/configs/m7_1_research_paper.yaml \\
...
def _setup_paths() -> None:
    """Make `training_m7_1.src` and `examples.run_grpo` importable."""
    paths = (REPO_ROOT, REPO_ROOT / "training_m7_1" / "nemo_rl")
    for p in paths:
        sp = str(p)
...
def main() -> None:
    ...
    import training_m7_1.src.registry  # noqa: F401
