#!/usr/bin/env bash
# M5.1 GRPO training launcher for ALICE — 2x A100-80GB variant.
#
# Differences from sbatch_m5_1.sh (1x A100):
...
#   - CHECKPOINT_DIR_BASE defaults to results/grpo_2xa100 so the 1x and 2x
...
#   sbatch training_m5_1/scripts/sbatch_m5_1_2xa100.sh
#   bash   training_m5_1/scripts/sbatch_m5_1_2xa100.sh --mode smoke      # inside srun
#
# See sbatch_m5_1.sh for the pre-req checklist (SIF, venv, parquet, .env).
...
export CHECKPOINT_DIR_BASE="${CHECKPOINT_DIR_BASE:-results/grpo_2xa100}"
