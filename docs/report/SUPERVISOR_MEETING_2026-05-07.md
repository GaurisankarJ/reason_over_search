...
- **Wall-clock (observed from Vast.ai 1× A100 80GB smoke)**: ~57 s/step for 20 trajectories (smoke shape). Scaled to the paper batch shape (510 trajectories/step × 1005 steps), this projects to **~11 to 17 days per run on 1× A100 80GB** (~\$300 to \$490 / run on Vast). On 1× H100 80GB SXM: ~5 to 8.5 days, \$240 to \$410 / run. On 2× A100: ~6.5 to 9.5 days, \$370 to $550 / run.
