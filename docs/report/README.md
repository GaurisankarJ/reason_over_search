...
| File | Purpose |
|---|---|
| [`SUPERVISOR_MEETING_2026-05-07.md`](./SUPERVISOR_MEETING_2026-05-07.md) | Canonical chapter-closing summary for the 2026-05-07 meeting (heavy rebuild 2026-05-07). § 0 TL;DR · § 1 Phase-1 (29 ALICE runs) · § 2 M1 Search-R1 baseline · § 3 M2 NeMo-RL pivot · § 4 M3 first eval (closed 2026-05-07: avg EM 0.102 → 0.155, +52 % rel) · § 5 compute reality + reframed RQ · § 6 next-steps recipe (E2H + S-GRPO + MC-GRPO + JustRL control). PDF alongside. |
| [`RESULTS_v2.md`](./RESULTS_v2.md) | M3 numerical record: per-dataset EM/ACC/F1 tables for both pre-GRPO and post-GRPO (z7kcxfof) on full Plan A (51,713 items / variant); training-side context; wall-clock observations; reproduction recipe. |
| [`PROGRESS_REPORT_01.md`](./PROGRESS_REPORT_01.md) | TL;DR + concise progress report covering 2026-04-23 to 2026-05-07. |
...
| [`CODE_SETUP_v2.md`](./CODE_SETUP_v2.md) | M3 eval pipeline: 14 alignment fixes between clone-and-run and the first clean comparison; per-mode dispatch (`prompt_mode=qwen3` vs `search_r1`); ReSearch comparison; reproduction. |
