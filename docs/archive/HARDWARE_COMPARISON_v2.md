---
title: HARDWARE_COMPARISON v2 (ARCHIVED) — accelerator + provider comparison for M5.1 training
tags: [hardware, training, m5, vast, runpod, thundercompute, gpu, archived]
source: internal
created: 2026-05-11
updated: 2026-05-11
archived: 2026-05-15
superseded_by: ../setup/HARDWARE_COMPARISON.md
supersedes: HARDWARE_COMPARISON_v1.md
---

> **ARCHIVED 2026-05-15.** This v2 was anchored on a projected B200 wall-clock of ~34h / 2.2 min-per-step (5-6× over A100). Live measurement on the b200-a3 run gave **~92h / 8.9 min-per-step (2.66× over A100)**, ~4× slower than this doc projected. Root cause: Blackwell sm_100 kernel immaturity in NeMo-RL/vLLM for BF16-dense small-batch (FP4/sparsity advantages don't apply). The Hopper (H100/H200) and A100 projections in this v2 are closer to accurate but the B200 column is wildly wrong. See [`../setup/HARDWARE_COMPARISON.md`](../setup/HARDWARE_COMPARISON.md) v3 for the calibrated numbers + the 2× H100 / 2× H200 / 4× A100 / 8× H200 SXM5 (Spheron) comparisons.
