...
created: 2026-05-11
updated: 2026-05-11
supersedes: ../archive/HARDWARE_COMPARISON_v0.md
---
...
>
> **Supersedes** [`../archive/HARDWARE_COMPARISON_v0.md`](../archive/HARDWARE_COMPARISON_v0.md), which was anchored on the step-8 33 min/step measurement. Per-step time has since collapsed to ~10 min/step (step 17) as the model learned shorter rollouts. The v0 numbers are off by 3× and its recommendation no longer holds; this doc replaces it.
>
...
- v0 of this doc (step-8 anchor; superseded): [`../archive/HARDWARE_COMPARISON_v0.md`](../archive/HARDWARE_COMPARISON_v0.md)
