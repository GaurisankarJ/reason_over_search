...
- **Stage-based approximation is cheap to test first**: ~300 steps per stage with manual fade is implementable in an hour and gets most of the gain without the schedule-curve plumbing. Our supervisor-meeting brief proposes this version ([`../report/SUPERVISOR_MEETING_2026-05-07.md` § 6](../report/SUPERVISOR_MEETING_2026-05-07.md)).
